...
public class RibbonsManager
{
  ...
  */
  private String ribImages[] = {"background1_3", "background1_2", "background1_1"};
  private double moveFactors[] = {0.3, 0.5, 0.8};  // applied to moveSize
